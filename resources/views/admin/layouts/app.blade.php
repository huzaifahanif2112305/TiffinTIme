...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard') | Tiffin Time Admin</title>
    ...
    <style>
        ...
        .sidebar {
            ...
            box-shadow: 0 0.15rem 1.75rem 0 rgba(234, 88, 12, 0.25);
        }
        ...
        <nav class="sidebar" id="sidebar">
            <div class="sidebar-brand">
                <div class="brand-content">
                    ...
                    <h1 class="sidebar-title">Tiffin Time</h1>
                </div>
            </div>
                        ...
                        <a href="{{ route('admin.verifications') }}"
                            ...
                            <span>Verifications
                                @if(isset($pendingVerifications) && $pendingVerifications > 0)
                                    <span class="badge rounded-pill ms-1" style="background:rgba(255,255,255,.3);font-size:.65rem;padding:2px 7px;">{{ $pendingVerifications }}</span>
                                @endif
                            </span>
                        </a>
                    </li>
