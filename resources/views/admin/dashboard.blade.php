                ...
                <div class="data-card h-100">
                    <div class="data-card-header">
                        <h5 class="data-card-title">
                            <i class="fas fa-user-check text-warning me-2"></i>Pending Seller Approvals
                        </h5>
                                ...
                                @foreach($pendingSellers as $seller)
                                    <li class="seller-item">
                                        <div class="seller-avatar">
                                            <img src="https://ui-avatars.com/api/?name={{ urlencode($seller->name) }}&background=4e73df&color=fff"
                                                alt="{{ $seller->name }}">
                                        </div>
                                        ...
                                        <div class="ms-auto d-flex align-items-center">
                                            ...
                                            <div class="d-flex">
                                                <form action="{{ route('admin.approveSeller', $seller->id) }}" method="POST"
                                                    class="me-2 approval-form approve-form" data-entity-type="Seller">
                                                    @csrf
                                                    <button type="submit" class="action-btn approve" data-bs-toggle="tooltip"
                                                        title="Approve Seller">
                                                        <i class="fas fa-check"></i>
                                                    </button>
                                                </form>
                                                <form action="{{ route('admin.rejectSeller', $seller->id) }}" method="POST"
                                                    class="approval-form reject-form" data-entity-type="Seller">
                                                    @csrf
                                                    <button type="submit" class="action-btn reject" data-bs-toggle="tooltip"
                                                        title="Reject Seller">
                                    ...
                                    <tbody>
                                        @foreach($pendingServices as $service)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <form action="{{ route('admin.approveService', $service->id) }}"
                                                            method="POST" class="me-2 approval-form approve-form"
                                                            data-entity-type="Service">
                                                            @csrf
                                                            <button type="submit" class="action-btn approve"
                                                                data-bs-toggle="tooltip" title="Approve Service">
                                                                <i class="fas fa-check"></i>
                                                            </button>
                                                        </form>
                                                        <form action="{{ route('admin.rejectService', $service->id) }}"
                                                            method="POST" class="approval-form reject-form"
                                                            data-entity-type="Service">
                                                            @csrf
                                                            <button type="submit" class="action-btn reject" data-bs-toggle="tooltip"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('admin.loginSeller', $seller->id) }}" method="POST">
                                                        @csrf
                                                        <button type="submit" class="action-btn view" data-bs-toggle="tooltip"
